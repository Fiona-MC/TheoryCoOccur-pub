...
if 'blackouts.txt' not in files:
    import requests
    url = 'https://raw.github.com/jeffalstott/powerlaw/master/manuscript/blackouts.txt'
    response = requests.get(url)
    with open('blackouts.txt', 'w') as f:
        f.write(response.text)
if 'words.txt' not in files:
    import requests
    url = 'https://raw.github.com/jeffalstott/powerlaw/master/manuscript/words.txt'
    response = requests.get(url)
    with open('words.txt', 'w') as f:
        f.write(response.text)
if 'worm.txt' not in files:
    import requests
    url = 'https://raw.github.com/jeffalstott/powerlaw/master/manuscript/worm.txt'
    response = requests.get(url)
    with open('worm.txt', 'w') as f:
        f.write(response.text)
